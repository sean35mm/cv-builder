...
http.route({
  path: '/profile-access/pdf-authorize-public',
  method: 'POST',
  handler: authorizePublicPdf,
});
http.route({
  path: '/profile-access/pdf-complete',
  method: 'POST',
  handler: completePublicPdf,
});
http.route({
  path: '/profile-access/configure',
  method: 'POST',
  handler: configure,
});
...
http.route({
  path: '/profile-access/contact',
  method: 'POST',
  handler: contact,
});
http.route({ path: '/profile-access/event', method: 'POST', handler: event });
http.route({
  path: '/profile-access/analytics-event',
  method: 'POST',
